    ...
    if option == "Add Emoji To Text":
        ...
        if submit:
            ...
            with tab1:
                ...
                with col1:
                    button1 = st.button("Yes", type='secondary')
                with col2:
                    button2 = st.button("No", type='secondary')
                if button1:
                    update_inputs_table(text, emojis)
                elif button2:
                    st.write("here")
                    adjusted = st.text_area('Enter emoji you think is appropriate to help our model do better', height=100)
                    button3 = st.button("Submit", type='secondary')
                    if button3:
